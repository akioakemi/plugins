...
class USteamUErBPLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_UCLASS_BODY()
		...
		static bool SteamUErUploadScoreToLeaderboard(FString leaderboardName, int score);
		...
		static bool SteamUErRequestLeaderboard(FString leaderboardName, int numScores, ESteamUErScoreTypeEnum leaderboardType);
